	...
	fn test_decoding_event() {
		...
		let log = RawLog {
			topics: vec![
				...
				hex!("0000000000000000000011111111111111111111111111111111111111111111").into(),
		...
		assert_eq!(
			...
			Log {
				params: [
					...
					("c", Token::Address(hex!("22222222222222222222222222222222222222222222").into())),
					("d", Token::Address(hex!("11111111111111111111111111111111111111111111").into())),
					(
						"e",
						Token::FixedBytes(
							hex!("00000000000000000aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").into()
